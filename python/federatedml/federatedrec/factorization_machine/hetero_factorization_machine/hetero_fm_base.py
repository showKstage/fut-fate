...
from federatedml.param.factorization_machine_param import HeteroFactorizationParam
...
class HeteroFMBase(BaseFactorizationMachine):
    def __init__(self):
        ...
        self.mode = consts.HETERO   # 模式
        self.aggregator = None  # 聚合器
        self.cipher = None      # 文件加密
        self.batch_generator = None     # 批处理生成器
        self.gradient_loss_operator = None   # 梯度损失算子
        self.converge_procedure = None    # 收敛过程
        self.model_param = HeteroFactorizationParam()    # 模型参数
