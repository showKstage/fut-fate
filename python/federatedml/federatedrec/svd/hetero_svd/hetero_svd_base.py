...
from federatedml.param.svd_param import HeteroSVDParam
...
class HeteroSVDBase(ModelBase):
    ...
    def _init_model(self, params):
        ...
        self.params = params
        self.transfer_variable = HeteroSVDTransferVariable() #传数据 加密?
        secure_aggregate = params.secure_aggregate
        if not self.has_registered:
            #withrole判断是guest or host or arbiter
        ...
        self.max_iter = params.max_iter #初始迭代次数
        self.aggregator_iter = 0  #当前迭代次数？
