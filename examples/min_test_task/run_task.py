...
class TrainTask(TaskManager):
    ...
    def run(self, start_serving=0):
        ...
        # python /tmp/changcheng.shao/examples/min_test_task/../../python/fate_flow/fate_flow_client.py -f submit_job -c /tmp/changcheng.shao/examples/min_test_task/test/submit_job_guest.config_1630677627_4096 -d /tmp/changcheng.shao/examples/min_test_task/config/test_hetero_lr_train_job_dsl.json
    ...
    def start_predict_task(self):
        ...
        # python /tmp/changcheng.shao/examples/min_test_task/../../python/fate_flow/fate_flow_client.py -f submit_job -c /tmp/changcheng.shao/examples/min_test_task/test/submit_job_guest.config_1630677861_3045
