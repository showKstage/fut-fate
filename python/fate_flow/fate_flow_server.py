...
from fate_flow.apps.fate_app import manager as fate_app_manager
...
if __name__ == '__main__':
    ...
    app = DispatcherMiddleware(
        manager,
        {
            ...
            '/{}/fate'.format(API_VERSION): fate_app_manager
        }
    )
    # init
    ...
    try:
        ...
        run_simple(hostname=IP, port=18080, application=app, threaded=True)
    except OSError as e:
        traceback.print_exc()
